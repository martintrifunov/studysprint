...
const TimerToggleButton = ({ isTimerRunning, stopTimer, startTimer, timerMode }) => {
  return (
    <View>
      <TouchableOpacity onPress={isTimerRunning ? () => stopTimer() : () => startTimer()}>
        <View style={isTimerRunning ? styles.buttonContainerStop : (timerMode === "Focus" ? styles.buttonContainerFocus : styles.buttonContainerBreak)}>
